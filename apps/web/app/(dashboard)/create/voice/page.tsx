      ...
      <Card className="bg-slate-900 border-slate-700">
        <CardContent className="flex flex-col items-center justify-center py-20 gap-6 text-center">
          <div className="p-6 bg-slate-800/50 rounded-full">
            <Mic className="h-16 w-16 text-slate-600" />
          </div>
          <div>
            ...
            <p className="text-slate-400 max-w-md">
              Convert text to natural-sounding voiceovers powered by ElevenLabs.
              Perfect for videos, podcasts, and social media content.
            </p>
          </div>
